...
class Dealer:
    ...
    def win(self, round, mystack, opstack, isbig, pot):
        r = 20 - round
    ...
    def start_game(self, max_round):
        ...
        for round_count in range(1, max_round + 1):
            ...
            #print(f"{round_count=}")
            #print(table.seats.players[0].stack)
            #print(table.seats.players[1].stack)
            isbig = round_count % 2 == 0
            if (
                self.win(
                    round_count,
                    table.seats.players[0].stack,
                    table.seats.players[1].stack,
                    isbig,
                    15
                )
                < 0
